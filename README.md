...
억울하거나 황당한 일을 한 줄로 적으면 브라우저 로컬 임베딩과 결정론적 규칙으로 밈 판결을 만드는 privacy-first 웹앱입니다. 원문은 공개 동의 전까지 브라우저를 떠나지 않습니다. 사용자가 별도로 확인한 공개 문장만 최대 90일 동안 Cloudflare D1에 보관되며, 고유 unlisted URL에서 익명 배심원 투표와 신고를 받을 수 있습니다.
