  ...
  return (
    <div className="app-shell">
      <header className="site-header">
        <a className="wordmark" href="/" aria-label="샤갈 재판소 홈"><span aria-hidden="true">샤</span><strong>샤갈 재판소</strong><small>SHAGAL COURT</small></a>
      ...
      <footer className="site-footer" id="privacy">
        ...
        <div><p>원문은 로컬 · 공개는 명시적 동의 · 익명 HMAC 식별 · 90일 자동 만료</p><p>© {new Date().getFullYear()} Overtura</p></div>
      </footer>
    </div>
  );
}
